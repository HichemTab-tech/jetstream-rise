                        ...
                        @foreach ($team->users->sortBy('name') as $user)
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center">
                                    ...
                                    @if (Gate::check('updateTeamMember', $team) && HichemTabTech\JetstreamRise\Jetstream::hasRoles())
                                        <button class="ms-2 text-sm text-gray-400 underline" wire:click="manageRole('{{ $user->id }}')">
                                            {{ HichemTabTech\JetstreamRise\Jetstream::findRole($user->membership->role)->name }}
                                        </button>
                                    @elseif (HichemTabTech\JetstreamRise\Jetstream::hasRoles())
